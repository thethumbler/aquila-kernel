 ...
 */
pub unsafe fn ringbuf_new(size: usize) -> *mut RingBuf {
 ...
 */
pub unsafe fn ringbuf_free(r: *mut RingBuf) -> () {
    if r.is_null() {
        return;
    }
 ...
 */
pub unsafe fn ringbuf_read(ring: *mut RingBuf, n: usize, buf: *mut u8) -> usize {
    let size = n;
    let mut n = n;
    let mut buf = buf;
 ...
 */
pub unsafe fn ringbuf_read_noconsume(ring: *mut RingBuf, off: off_t, n: usize, buf: *mut u8) -> usize {
    let size = n;
...
pub unsafe fn ringbuf_write(ring: *mut RingBuf, n: usize, buf: *mut u8) -> usize {
    let size = n;
...
pub unsafe fn ringbuf_write_overwrite(ring: *mut RingBuf, n: usize, buf: *mut u8) -> usize {
    let size = n;
