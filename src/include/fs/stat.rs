...
#[macro_export]
macro_rules! S_ISSOCK { ($n:expr) => { ((($n) & S_IFMT) == S_IFSOCK) } }
#[macro_export]
macro_rules! S_ISLNK  { ($n:expr) => { ((($n) & S_IFMT) == S_IFLNK)  } }
#[macro_export]
macro_rules! S_ISREG  { ($n:expr) => { ((($n) & S_IFMT) == S_IFREG)  } }
#[macro_export]
macro_rules! S_ISBLK  { ($n:expr) => { ((($n) & S_IFMT) == S_IFBLK)  } }
#[macro_export]
macro_rules! S_ISDIR  { ($n:expr) => { ((($n) & S_IFMT) == S_IFDIR)  } }
#[macro_export]
macro_rules! S_ISCHR  { ($n:expr) => { ((($n) & S_IFMT) == S_IFCHR)  } }
#[macro_export]
macro_rules! S_ISIFO  { ($n:expr) => { ((($n) & S_IFMT) == S_IFIFO)  } }
